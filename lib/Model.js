...
class Model extends AbstractModel {
  ...
  static query(query, bindings, queryOpts) {
    return this.fromRow(this.mysql().query(query, bindings, queryOpts), queryOpts);
  }
  ...
  static selectOne(query, bindings, queryOpts) {
    return this.fromRow(this.mysql().selectOne(query, bindings, queryOpts), queryOpts);
  }
  ...
  static mysql() {
    if (sand.context && sand.context.mysql) {
      ...
      memoize.property(sand.context.mysql, 'query', concurrentConfig);
      memoize.property(sand.context.mysql, 'selectOne', concurrentConfig);
