...
class Connection extends EventEmitter {
  ...
  isAutoReconnectError(err) {
    ...
    return err && this.config.autoReconnect && (_.indexOf(reconnectErrors, err.code) !== -1 || _.indexOf(temporaryErrors) !== -1) && this.numRetries < this.config.maxRetries && !this.isInTransaction
  }
}
